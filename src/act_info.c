...
/* start from last to first to get it in the proper order */
	...
	case MAX_LEVEL -  0: race = "President";	break;
	case MAX_LEVEL -  1: race = "Executive";	break;
	case MAX_LEVEL -  2: race = "Senator";	break;
	case MAX_LEVEL -  3: race = "Engineer";	break;
	case MAX_LEVEL -  4: race = "Retired";	break;
	}
